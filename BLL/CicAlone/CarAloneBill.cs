...
{
    public class CarAloneBill
    {
        //创建数据层对象
        CarAloneDal miDal = new CarAloneDal();
        ...
        {
            //调用查询方法
            return miDal.GetListAll(carInfo);
        }
        ...
        public bool DeleteCicData(String batch)
        {
            return miDal.DeleteCicData(batch) > 0;
        }
